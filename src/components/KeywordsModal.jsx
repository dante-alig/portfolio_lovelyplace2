 ...
 */
const KeywordsModal = ({ isOpen, onClose, locationId, currentKeywords, onKeywordsUpdate }) => {
  ...
  const handleAddKeyword = async () => {
    ...
    try {
      ...
      const updatedKeywords = await updateKeywords(locationId, "add", [newKeyword]);
  ...
  const handleRemoveKeyword = async (keyword) => {
    try {
      ...
      const updatedKeywords = await updateKeywords(locationId, "remove", [keyword]);
      // Mise à jour de l'interface utilisateur
      onKeywordsUpdate(updatedKeywords);
    } catch (error) {
